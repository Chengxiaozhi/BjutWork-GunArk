...
namespace Gunark.BLL
{
	...
	{
        private readonly Gunark.DAL.group dal = new Gunark.DAL.group();
        public group()
		{}
        #region  BasicMethod
        /// <summary>
        ...
        /// 得到一个对象实体，从缓存中
        /// </summary>
        public Gunark.Model.group GetModelByCache(string GROUP_ID)
        {
            ...
            return (Gunark.Model.group)objModel;
        }
        ...
        /// 获得数据列表
        /// </summary>
        public List<Gunark.Model.group> GetModelList(string strWhere)
        {
        ...
        /// 获得数据列表
        /// </summary>
        public List<Gunark.Model.group> DataTableToList(DataTable dt)
        {
            List<Gunark.Model.group> modelList = new List<Gunark.Model.group>();
            int rowsCount = dt.Rows.Count;
            if (rowsCount > 0)
            {
                Gunark.Model.group model;
